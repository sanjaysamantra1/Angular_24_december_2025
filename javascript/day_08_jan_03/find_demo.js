...
// display the index where first female employee exists
...
// display the index where last female employee exists
let last_female_emp_ind = employees.findLastIndex((emp) => emp.gender == 'female');
console.log(last_female_emp_ind);

// display all female employee in this list
let all_female_emp = employees.filter((emp) => emp.gender == 'female' && emp.eId == 102);
